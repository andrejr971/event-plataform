...
export type GetLessonBySlugQuery = { __typename?: 'Query', lesson?: { __typename?: 'Lesson', title: string, slug: string, description?: string | null, id: string, availableAt?: any | null, videoId: string, teacher?: { __typename?: 'Teacher', avatarURL: string, id: string, name: string, bio: string } | null } | null };
